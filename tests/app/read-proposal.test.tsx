...
import ReadProposal from "../../app/read-proposal";
...
describe("Read Proposal Integration Test", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  it("fetches proposal details and renders correctly", async () => {
    // Arrange
    const mockProposal = {
      id: "proposal-id-123",
    ...
    const mockMember = { id: "host-id-789", name: "Host Name" };
    ...
    expect(await screen.findByText("Host Name")).toBeTruthy();
  });
});
